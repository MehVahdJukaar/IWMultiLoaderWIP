...
public class ModFoods {
    ...
    public static final FoodProperties MOSS_CLUMP = (new FoodProperties.Builder()).nutrition(1).saturationMod(0.2F).alwaysEat().fast().build();

    public static final FoodProperties GOLDEN_MOSS_CLUMP = (new FoodProperties.Builder()).nutrition(4).saturationMod(0.6F).alwaysEat()
    ...
    public static final FoodProperties ICICLE = (new FoodProperties.Builder()).nutrition(0).saturationMod(0F).alwaysEat().fast()
            .effect(new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 80, 1,false,true), 1F).build();
}
