...
public class MossyStairsBlock extends ModStairs implements Mossable, BonemealableBlock {

    private final MossLevel mossLevel;

    public MossyStairsBlock(MossLevel mossLevel, BlockState state, Properties properties) {
